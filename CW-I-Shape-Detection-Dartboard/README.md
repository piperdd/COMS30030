...
PLEASE AVOID USING AI TOOLS. Relying on AI tools will prevent learning and development of fundamental skills that you’ll need to use in the future. [This coursework is a Category 2 on the UoB guidance scale on the use of AI in assessments.][https://www.bristol.ac.uk/bilt/sharing-practice/guides/guidance-on-ai/using-ai-in-assessment/] All submissions will be checked (via manual and automated tools) for the use of AI and appropriate measures will be taken if reasonable doubt regarding the use of AI arises.
